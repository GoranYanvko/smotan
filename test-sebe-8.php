...
<head>
	<title>Характера ми - TEST</title>
            ...
            <meta name="keywords" content="Характер, нрави, способност" />
            <meta name="description" content="Интересен тест за изследване на вашия характер - ТЕСТ" />
...
var text=""
	function CountRez() {
		...
		if (count<10) {text="Вие притежавате твърд характер. Никой не може да ви промени обежденията, готови сте да ги браните със зъби и нокти.";}
		if ((count>9)&&(count<17)) {text=" Уравновесена и стабилна Между двете крайности - Вие сте златната среда. Характера ви е благ и приятен за околните.";}
		if (count>16) {text="Вие сте направо душичка мирна и спокойна. Съгласявате се с другите като ангел.";}
...
<h5>Какъв характер съм</h5><br />
<TABLE cellSpacing="0" cellPadding="30" width="500" border="0">
  <TBODY>
  <TR>
    <TD>
         <b> 1. Ако не ми върнат рестото"</b>
      <FORM>
           <INPUT onclick=r1=0 type=radio value=V1 name=R1> 
                        <tt> Вдигам грандиозен скандал</tt>
                     <br />
           <INPUT onclick=r1=2 type=radio value=V2 name=R1> 
                       <tt>Моля да ми го върнат</tt>
                     <br />
           <INPUT onclick=r1=4 type=radio value=V3 name=R1> 
                        <tt>заминавам си без да го взема</tt>
      </FORM>

       <b>  2. Когато съм в компания:</b>

      <FORM>
           <INPUT onclick=r2=4 type=radio value=V1 name=R2> 
                           <tt>Изслушвам другите и се опитвам да вземам участие</tt>
                  <br />
           <INPUT onclick=r2=2 type=radio value=V2 name=R2> 
                           <tt>Забавляваме се</tt>
                  <br />
           <INPUT onclick=r2=0 type=radio value=V3 name=R2> 
                         <tt>Аз съм центъра на разговора</tt>
     </FORM>

       <b>   3. Когато някой спори с вас:</b>

     <FORM>
            <INPUT onclick=r3=0 type=radio value=V1 name=R3> 
                  <tt>Не може да ми промени мнението</tt>
                <br />
           <INPUT onclick=r3=4 type=radio value=V2 name=R3> 
                  <tt>съгласявам се с другия</tt>
               <br />
           <INPUT onclick=r3=2 type=radio value=V3 name=R3> 
                <tt>Зависи от доводите дали ще си променя мнението</tt>
      </FORM>

        <b>  4. Когато говоря по GSM на обществено място:</b>

      <FORM>
                <INPUT onclick=r4=0 type=radio value=V1 name=R4> 
                   <tt> Искам всички да ме видят</tt>
                     <br />
                <INPUT onclick=r4=4 type=radio value=V3 name=R4> 
                    <tt>Гледам никой да не ме види</tt><br />
                <INPUT onclick=r4=2 type=radio value=V3 name=R4> 
                    <tt>Не обръщам внимание на другите</tt>
      </FORM>
      ...
      <FORM>
        ...
        <b> 6. Човек на компромисите ли сте ?</b>
