...
<head>
	<title>Умеете ли да спорите</title>
            ...
            <meta name="keywords" content="спор, кавга, караница, дуел, анализ, тест" />
            <meta name="description" content="Умеете ли да спорите и излизате ли като победител от дадена ситоация - ТЕСТ" />
...
var text=""
	function CountRez() {
		...
		if (count<10) {text="Много слаб противник сте в спорта. Обичате да избягвате споровете с дипломатичен разговор.";}
		if ((count>9)&&(count<17)) {text="Зависи с кого спорите ако е слаб противник 100% ще го надвиете, но срещу по силен ще видите бая зор.";}
		if (count>16) {text="Умеете ли да спорите - определено това е вашата стихия !!!";}
    ...
    <TD>
      ...
      <FORM>
           <INPUT onclick=r2=4 type=radio value=V1 name=R2> 
                           <tt>Са хладнокръвни като лет</tt>
                  <BR>
       ...
       <b>   3. Променяте ли си цвета на лицето в конфузни ситоаци:</b>
     ...
     <FORM>
        ...
        <b>  4. Когато говорите бързо бъркате ли думите:</b>
      ...
      <FORM>
         ...
         <b>5. Начина по който достигате до целите си е чрез:</b>
