...
<head>
	<title>Хитрец ли си</title>
            ...
            <meta name="keywords" content="хитър, лъжез, измамник, лош, човек, животно, ловък" />
            <meta name="description" content="Провери дали си човек, които може с хитрост и ловкост да се измъкни от затруднена ситуация." />
...
var text=""
	function CountRez() {
		...
		if (count<10) {text="Никаква хитрост няма във вашата душа. искрена и чиста като капка вода.";}
		if ((count>9)&&(count<17)) {text="Не много добър, но и не много слаб хитрец сте. В критична ситуация може вашата хитрост да ви измъкни, но в друга да ви закопае.";}
		if (count>16) {text="С успех могат да ти викат Хитреца. За тебе е в сила казаното, че и на краставичар можеш да продадеш краставица.";}
