...
<head>
	<title>Лесно ли се влюбвате - Тест </title>
            ...
            <meta name="keywords" content="влчбване, лесно, обич, ревност, тест" />
            <meta name="description" content="Проверете дали се влбвате лесно като направите този тест" />
...
var text=""
	function CountRez() {
		...
		if (count<10) {text="Изключително хладнокръвни, за да бъдете с някой човек то той трябва да свали не една звезда, а цялото звездно небе в краката ви. Сърцето и неговите шепоти не значат нищо за вас. Водещата сила при вас е разума.";}

		if ((count>9)&&(count<17)) {text=" Вие сте умерен човек. Нито сте твърде хладнокръвен нито сте прекалено влюбчиви. Не хващате момиче/момче за една вечер и после кой от където е. Олицетворение сте на равновесието между сърцето и разума.";}

		if (count>16) {text="Определено сте изключително лесно влюбчива натура. Ако намерите човек, който ви харесва на мига се влюбвате в него. Не слушате разума нито приятелите. Вие искате просто този човек и ще направите всичко възможно, за да сте с него.";}
...
<TABLE cellSpacing="0" cellPadding="30" width="500" border="0">
  ...
  <TR>
    ...
    <TD>
           <b>1. Вашето определение за любовта: </b>
      <FORM>
           ...
           <INPUT onclick=r1=0 type=radio value=V3 name=R1> 
                        ...
                        <tt>Секс за една нощ</tt>

      </FORM>



       <b>  2. В живота се подчинявате на:</b>
      ...
      <FORM>
           ...
           <INPUT onclick=r2=0 type=radio value=V1 name=R2> 
                        ...
                        <tt> На никого не се подчинявам</tt>
         ...
         <b> 3.Според вас любовта прилича на:</b>
     ...
     <FORM>
           ...
           <INPUT onclick=r3=0 type=radio value=V3 name=R3> 
                  ...
                  <tt> Москвич на тате</tt>

      </FORM>



         <b> 4. Броя на гаджетата ви е:</b>
      ...
      <FORM>
                ...
                <INPUT onclick=r4=4 type=radio value=V1 name=R4> 
                      ...
                      <tt>Повече от 2 само този месец</tt>

                     <br />

                <INPUT onclick=r4=2 type=radio value=V2 name=R4> 

                     <tt> Някъде около 10 изобщо</tt>
        ...
        <b> 5.На първа среща с новото гадже:</b>
      ...
      <FORM>
                ...
                <INPUT onclick=r5=2 type=radio value=V1 name=R5> 
                       ...
                       <tt> Просто се старая да си прекарваме приятно</tt>

                     <br />

                <INPUT onclick=r5=0 type=radio value=V2 name=R5> 

                       <tt> Опитвате се да откриете нещо интересно в него</tt>

                     <br />

                <INPUT onclick=r5=4 type=radio value=V3 name=R5> 

                     <tt> Сравнявате го с предишните</tt>

     </FORM>



         <b>6. След края на първате ви среща:</b>
      ...
      <FORM>
             ...
             <INPUT onclick=r6=4 type=radio value=V1 name=R6> 
                       ...
                       <tt> Целувате човека до вас по устните</tt>

                  <br />

             <INPUT onclick=r6=2 type=radio value=V2 name=R6> 

                       <tt> Целувка за чао по бузата</tt>

                  <br />

             <INPUT onclick=r6=0 type=radio value=V3 name=R6>  

                        <tt> Нежен поглед за чао </tt>
