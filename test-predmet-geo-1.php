...
<head>
	<title>Тест по география на тема "земята като небесно тяло" </title>
            ...
            <meta name="keywords" content="география, изпит, развити, тест, тестове, теми" />
...
<h5>Тест по география на тема "земята като небесно тяло"</h5>
<TABLE cellSpacing="0" cellPadding="30" width="500" border="0">
  <TBODY>
  <TR>
    <TD>
           <b>1. Оста около която земята се върти около себе си се нарича:</b>
      <FORM>
...
<br />
       ...
       <b>  2. Разстоянието от Слънцето до Земята равно на 190мил.км се нарича:</b>

      <FORM>
           <INPUT onclick=r2=1 type=radio value=V1 name=R2> 
                        <tt>Основна астрономична единица</tt>
                  <br />
           <INPUT onclick=r2=0 type=radio value=V2 name=R2> 
                          <tt>Нулева рамка</tt>
<br />
           <INPUT onclick=r2=0 type=radio value=V3 name=R2> 
                          <tt>Астрономичен контакт</tt>

     </FORM>


         <b> 3. Еклиптика се нарича: </b>

     <FORM>
            <INPUT onclick=r3=0 type=radio value=V1 name=R3> 
                 <tt>Движението на Земята около оста на вселената</tt>
                <br />
           <INPUT onclick=r3=1 type=radio value=V2 name=R3> 
                  <tt>Движението на Земята по елиптична ос около слънцето</tt>
                <br />
           <INPUT onclick=r3=0 type=radio value=V3 name=R3> 
                  <tt>Движението на Земята около себе си</tt>


      </FORM>

         <b> 4. От Слънцето Земята се намира на:</b>
      ...
      <FORM>
                ...
                <INPUT onclick=r4=0 type=radio value=V2 name=R4> 
                     <tt> на четвърто място</tt>
                     <br />
                <INPUT onclick=r4=1 type=radio value=V3 name=R4> 
                     <tt> на трето място</tt>

      </FORM>
 
        <b> 5. Посоката на орбиталното движение на земята е: </b>

      <FORM>
                <INPUT onclick=r5=1 type=radio value=V1 name=R5> 
                       <tt>Обратно на часовниковата стрелка</tt>
                     <br />
                <INPUT onclick=r5=0 type=radio value=V2 name=R5> 
                       <tt>По посока на часовниковата стрелка</tt>
                     <br />
                <INPUT onclick=r5=0 type=radio value=V3 name=R5> 
                     <tt>Периетално</tt>
     </FORM>

         <b>6. Прецесия се нарича:</b>
 
      <FORM>
             <INPUT onclick=r6=1 type=radio value=V1 name=R6> 
                       <tt>Изпреварването на равноденствоето с 50 дъбови секунди</tt>
                  <br />
             <INPUT onclick=r6=0 type=radio value=V2 name=R6> 
                       <tt>Промяна в сплеснатоста на Земната орбита с 1 градус</tt>
                  <br />
             <INPUT onclick=r6=0 type=radio value=V3 name=R6>  
                        <tt>Разположението на Земята спрямо Луната</tt>
      </FORM>
