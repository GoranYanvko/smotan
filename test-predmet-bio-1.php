...
<head>
	<title>Тестове по Биология тема клетка - ТЕСТ</title>
            ...
            <meta name="keywords" content="Биология, клетка, тест, тестове, теми" />
            <meta name="description" content="Тестове по биология за кандидат-студенти на тема клетка и още други теми в нашия сайт." />
  ...
  <TR> 
    <TD> 
      ...
      <FORM> 
         ...
         <b> 3. Белтъците са изградени от: </b> 
     ...
     <FORM> 
         ...
         <b> 4. Кой вид транспорт изисква енергия:</b> 
      ...
      <FORM> 
                ...
                <INPUT onclick=r4=1 type=radio value=V3 name=R4>  
                     <tt>Транспортен белтък</tt> 
      </FORM> 
  
        <b> 5. Белтъчния синтез се осъществява в: </b> 
 
      <FORM> 
                <INPUT onclick=r5=0 type=radio value=V1 name=R5>  
                       <tt> Апарата на Голджи</tt> 
                     <br /> 
         ...
         <b>6. Кой от посочените НЕ е мембранен органел:</b> 
  
      <FORM> 
             <INPUT onclick=r6=0 type=radio value=V1 name=R6>  
                       <tt>Апарат на Голджи</tt> 
                  <br /> 
