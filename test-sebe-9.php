...
<head>
	<title>ИМАТЕ ЛИ ЧУВСТВО ЗА ХУМОР</title>
            ...
            <meta name="keywords" content="хумор, смях, humor, smqh, vizove, smeshki" />
            <meta name="description" content="Мислите си че имате чувство за хумор, че сте забавни? Проверете това дали е истина като направите този бърз тест" />
...
var text=""
	function CountRez() {
		...
		if (count<10) {text="Вашето чувство за хумор не е много високо. С лекота може да се пресмете на чужд човек, но ако се смеят за същата ситуация на вас е недопустимо!";}
		if ((count>9)&&(count<17)) {text="Притежавате едно добро чувство за хумор. Смеете се на добрите шеги дори да са на ваш гръб.";}
		if (count>16) {text="Определено вие имате страхотно чувство за хумор. В компанията вие сте центъра!";}
...
<h5>ИМАТЕ ЛИ ЧУВСТВО ЗА ХУМОР</h5><br />
<TABLE cellSpacing="0" cellPadding="30" width="500" border="0">
  <TBODY>
  <TR>
    <TD>
         <b> 1. Можете ли да разказвате вицове ?</b>
      <FORM>
       ...
       <b>  2. Когато сте в компания:</b>

      <FORM>
           <INPUT onclick=r2=4 type=radio value=V1 name=R2> 
                           <tt>Чувствате се щастливи</tt>
                  <br />
           <INPUT onclick=r2=2 type=radio value=V2 name=R2> 
                           <tt>Чувствате се добре</tt>
                  <br />
           <INPUT onclick=r2=0 type=radio value=V3 name=R2> 
                         <tt>Безразлично</tt>
     </FORM>

       <b>   3. Ако се подхлъзнете и паднете:</b>

     <FORM>
            <INPUT onclick=r3=0 type=radio value=V1 name=R3> 
                  <tt>Почвате да псувате</tt>
                <br />
           <INPUT onclick=r3=4 type=radio value=V2 name=R3> 
                  <tt>Ухилвам се до уши и се смея на късмета си</tt>
               <br />
           <INPUT onclick=r3=2 type=radio value=V3 name=R3> 
                <tt>Оглеждам се да видя дали някой ме е познал</tt>
      </FORM>

        <b>  4. Ако вместо подарък ви подарят нещо, на което не знаеш предназначението:</b>

      <FORM>
                <INPUT onclick=r4=0 type=radio value=V1 name=R4> 
                   <tt> Мрънкам докато ми го подарят</tt>
                     <br />
                <INPUT onclick=r4=4 type=radio value=V3 name=R4> 
                    <tt>Радвам се на новата придобивка</tt><br />
                <INPUT onclick=r4=2 type=radio value=V3 name=R4> 
                    <tt>Опитвам се да открия какво прави тази джундурия</tt>
      </FORM>
 
         <b>5. Срам ли ви е да се хилите на глас:</b>

      <FORM>
                <INPUT onclick=r5=2 type=radio value=V1 name=R5> 
                      <tt>Зависи от компанията</tt>
                     <br />
                <INPUT onclick=r5=0 type=radio value=V2 name=R5> 
                      <tt>ДА</tt>
                     <br />
                <INPUT onclick=r5=4 type=radio value=V2 name=R5> 
                      <tt>НЕ ме е срам, намирам го за чаровно</tt>

     </FORM>

        <b> 6. Смете ли се понякога до сълзи?</b>
